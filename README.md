...
1. - [x] Set up the initial React project structure - [Alex](https://github.com/aleksandramuraveva)
1. - [x] Create App component logic - [Alex](https://github.com/aleksandramuraveva)
...
1. - [x] Create ToDoItem component logic - [Noel](https://github.com/imanmaulana1)
1. - [x] Create AddToDo form component logic - [Noel](https://github.com/imanmaulana1)
1. - [ ] Create Footer component logic - []()
1. - [ :clock5: ] Create Filter component logic - [Francis](https://github.com/Francis7575)
...
1. - [x] Style ToDoItem component using CSS - [Noel](https://github.com/imanmaulana1)
1. - [x] Style AddToDo form component using CSS - [Noel](https://github.com/imanmaulana1)
...
1. - [ :clock5: ] Add local storage support to persist tasks - [Francis](https://github.com/Francis7575)
1. - [ :clock5: ] Create a custom hook useLocalStorage for managing tasks - [Francis](https://github.com/Francis7575)
...
1. - [ :clock5: ] Implement filtering options (e.g., all, active, completed) - [Francis](https://github.com/Francis7575)
